...
import { createRequireProxyAuth, deriveSandboxMcpToken } from "../../../../server/middleware/auth";
...
export function createDevtoolsMcpProxyRoutes(hubManager: HubManager, env: GatewayEnv): RouterType {
	...
	router.use("/:breezeSessionId/:token/devtools/mcp", requireProxyAuth, ensureSessionReady, proxy);
	return router;
}
